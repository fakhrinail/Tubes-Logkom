...
assignQuest :- 
    ...
    asserta(jmlWolf(Z)),
    retract(rewardGold(_)),
    RewardGold is (X+Y+Z)*40,
    asserta(rewardGold(RewardGold)),
    retract((_)),
    RewardExp is (X+Y+Z)*40,
    asserta(rewardExp(RewardExp)),
    retract(isOnQuest(_)),
    asserta(isOnQuest(1)),
...
assignQuest :- 
    ...
    retract(rewardGold(_)),
    RewardGold is (W+X+Y+Z)*60,
    asserta(rewardGold(RewardGold)),
    retract((_)),
    RewardExp is (W+X+Y+Z)*60,
    asserta(rewardExp(RewardExp)),
    retract(isOnQuest(_)),
    asserta(isOnQuest(1)),
...
assignQuest :- 
    ...
    asserta(jmlOgre(Z)),
    retract(rewardGold(_)),
    RewardGold is (W+X+Y+Z)*100,
    asserta(rewardGold(RewardGold)),
    retract((_)),
    RewardExp is (W+X+Y+Z)*100,
    asserta(rewardExp(RewardExp)),
    retract(isOnQuest(_)),
    asserta(isOnQuest(1)),
...
assignQuest :- 
    ...
    retract(rewardGold(_)),
    RewardGold is (X+Y+Z)*125,
    asserta(rewardGold(RewardGold)),
    retract((_)),
    RewardExp is (X+Y+Z)*125,
    asserta(rewardExp(RewardExp)),
    retract(isOnQuest(_)),
    asserta(isOnQuest(1)),
...
assignQuest :- 
    ...
    retract(rewardGold(_)),
    RewardGold is (X+Y+Z)*150,
    asserta(rewardGold(RewardGold)),
    retract((_)),
    RewardExp is (X+Y+Z)*150,
    asserta(rewardExp(RewardExp)),
    retract(isOnQuest(_)),
    asserta(isOnQuest(1)),
