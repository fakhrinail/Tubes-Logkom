...
assignQuest :- 
    ...
    retract(rewardGold(_)),
    RewardGold is (X+Y)*100,
    RewardExp is (X+Y)*100,
    retract(rewardGold(_)),
    asserta(rewardGold(RewardGold)),
    retract(rewardExp(_)),
    asserta(rewardExp(RewardExp)),
...
assignQuest :- 
    ...
    retract(jmlOgre(_)),
    asserta(jmlOgre(Z)),
    RewardGold is (X+Y)*125,
    RewardExp is (X+Y)*125,
    retract(rewardGold(_)),
    asserta(rewardGold(RewardGold)),
    retract(rewardExp(_)),
    asserta(rewardExp(RewardExp)),
...
assignQuest :- 
    ...
    RewardGold is (X+Y)*150,
    RewardExp is (X+Y)*150,
    retract(rewardGold(_)),
    asserta(rewardGold(RewardGold)),
    retract(rewardExp(_)),
    asserta(rewardExp(RewardExp)),
...
assignQuest :- 
    ...
    RewardGold is (X+Y)*200,
    RewardExp is (X+Y)*200,
    retract(rewardGold(_)),
    asserta(rewardGold(RewardGold)),
    retract(rewardExp(_)),
    asserta(rewardExp(RewardExp)),
